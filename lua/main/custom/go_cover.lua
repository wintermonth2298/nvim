...
vim.api.nvim_command('command! GoCov lua require("main.custom.go_cover").toggle_coverage()')
vim.api.nvim_command('command! GoCovHtml lua require("main.custom.go_cover").open_coverage_in_browser()')
